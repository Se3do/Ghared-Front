        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-3xl mx-auto">
            <Card className="border-border/50 shadow-xl">
              <CardHeader className="bg-gradient-to-br from-primary via-primary/90 to-primary/70 text-primary-foreground rounded-t-lg">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <Card className="border-border/50 shadow-xl overflow-hidden animate-fade-in">
            {/* Profile Header */}
            <CardHeader className="bg-gradient-to-br from-primary via-primary/90 to-primary/70 text-primary-foreground p-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <Avatar className="w-20 h-20 border-4 border-white/30 shadow-lg">
                      ...
                      <AvatarFallback className="bg-primary/80 text-primary-foreground text-xl font-bold">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        ...
                        />
                        <Phone
                          className={`absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors ${isEditMode ? "text-primary" : "text-muted-foreground/50"
                            }`}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        ...
                        >
                          ...
                          <Upload
                            className={`w-5 h-5 transition-colors ${isEditMode ? "text-primary" : "text-muted-foreground/50"
                              }`}
                          />
                        </Button>
                      </div>
                ...
                {isEditMode && (
                  <div className="flex justify-center pt-6 animate-fade-in">
                    <Button
                      ...
                      className="px-12 gap-2 bg-gradient-to-br from-primary via-primary/90 to-primary/70 hover:from-primary/90 hover:to-primary/60 shadow-lg hover:shadow-xl transition-all duration-300 text-primary-foreground"
                    >
                      {isSubmitting ? (
                        <>
